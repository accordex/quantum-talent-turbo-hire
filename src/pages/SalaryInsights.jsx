              ...
              <div className="h-48">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={percentileData} margin={{ top: 5, right: 5, bottom: 5, left: 10 }}>
                    ...
                    <Tooltip formatter={(v) => [`$${Math.round(Number(v) / 1000)}K`, "Salary"]} contentStyle={{ background: "hsl(var(--card))", border: "1px solid hsl(var(--border))", borderRadius: "12px" }} />
                  ...
                  <div className="h-48">
                    <ResponsiveContainer width="100%" height="100%">
                      <BarChart data={locationData} layout="vertical" margin={{ top: 5, right: 30, bottom: 5, left: 10 }}>
                        ...
                        <Tooltip formatter={(v) => [`$${Math.round(Number(v) / 1000)}K`, "Median"]} contentStyle={{ background: "hsl(var(--card))", border: "1px solid hsl(var(--border))", borderRadius: "12px" }} />
