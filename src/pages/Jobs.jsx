...
export default function Jobs() {
  ...
  const filteredJobs = useMemo(() => {
    ...
    // Sort
    if (sortBy === "latest") result = [...result].sort((a, b) => new Date(b.created_date).getTime() - new Date(a.created_date).getTime());
      ...
      <div className="bg-gradient-to-b from-card/80 to-transparent border-b border-border/30 py-8">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="flex gap-2">
            ...
            <Button className="h-12 px-5 rounded-xl shrink-0">Search</Button>
          </div>
