...
import { MapPin, Clock, Building2, Bookmark, Share2, Send, DollarSign, Star, TrendingUp, Zap } from "lucide-react";
...
export default function JobCard({ job, onSave, isSaved, index = 0, matchScore }) {
